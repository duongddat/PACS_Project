...
export const useStudyStore = create<StudyState>((set, get) => ({
      ...
      set({
        ...
        error:
          error instanceof Error
            ? error.message
            : "Lỗi không xác định khi tải nghiên cứu",
      });
    }
  },
  ...
  fetchStudyByUID: async (studyInstanceUID) => {
    set({ isLoading: true, error: null });
    try {
      const studies = await DicomWebApi.getStudies({
      ...
      set({
        ...
        error:
          error instanceof Error
            ? error.message
            : "Lỗi không xác định khi tải thông tin nghiên cứu",
      });
    }
  },
    ...
    try {
      ...
      set({
        ...
        error:
          error instanceof Error
            ? error.message
            : "Lỗi không xác định khi tải series",
      });
    }
  },
    ...
    try {
      ...
      set({
        ...
        error:
          error instanceof Error
            ? error.message
            : "Lỗi không xác định khi tải instances",
      });
    }
  },
